      ...
      DATA: [
        {
          ...
          tile: 'New Offer',
          key: 1,
          offerContent:'New User Offer - Get EGP 5 Credit;{/n} Book Rides In Egypt From EGP 100. Most Used Careem Voucher Code 2020. Total Offers, 2. Online Code, 1.'
...

        {
          ...
          tile: 'New Offer',
          key: 3,
          offerContent:'New User Offer - Get EGP 5 Credit; Book Rides In Egypt From EGP 100. Most Used Careem Voucher Code 2020. Total Offers, 2. Online Code, 1.'
    ...
    return (
      <View style={styles.card}>
       <TouchableScale
          ...
          activeScale={.7}
          friction={7}
          onPress={() => this.props.navigation.navigate('OfferDetails', { item:item ,active:true })}>
    ...
    return (
      <View style={styles.FlatListContainer}>
        ...
        <View style={styles.headerContainer}>
            ...
            <Image source={i20} style={{width: 40, height: 40, borderRadius:15,paddingTop:10}}/>
            </View>
